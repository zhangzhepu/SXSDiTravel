...
<script type="text/javascript">
		function myvalidate(){/*验证用户名*/	
		
		    var msg=document.getElementById("stu_mail");
		    var msg1=document.getElementById("stu_pwd");
		   	var info=document.getElementById("info");
		   	var info1=document.getElementById("info1");
			var stu_mail = msg.value.trim();
			var stu_pwd = msg1.value.trim();
			if(stu_mail.length==0){
				info.innerHTML= '<font color="red"> 您还未输入邮箱</font>';
				document.form1.stu_mail.focus();
				return false;
			}else if(stu_pwd.length==0){
				info.innerHTML= '';
				info1.innerHTML= '<font color="red"> 您还未输入密码</font>';
...
<!--登录开始-->
    <div class="reg login">
        <form action="servlet/LoginAction" method="post" name="form1" id="form1" onsubmit="return myvalidate();">
            <dl>
                <div style="height:17px; overflow:hidden">
                </div>
                <dd>
                <span class="title">登录邮箱：</span>
                <input type="text" class="reg_input" name="stu_mail" id="stu_mail" value="<%=mail==null?"":mail%>"/><font color="red">
                <span id="info">
                <%if(flag==null){
                out.print("");
                }else if(flag.equals("0")){
                out.print("<font color='red'>帐号或密码有误</font>");
                }else if(flag.equals("1")){
                out.print("<font color='greed'>注册成功！现在登录</font>");
                } %>
				</span>
                </font>
                </dd>
                ...
                <input  type="password" class="reg_input" name="stu_pwd" id="stu_pwd" />
                <span id="info1"></span>
                </dd>
